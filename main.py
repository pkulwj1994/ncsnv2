...
def parse_args_and_config():
    ...
    parser.add_argument('--sample', action='store_true', help='Whether to test the model')
    parser.add_argument('--fast_fid', action='store_true', help='Whether to test the model')
